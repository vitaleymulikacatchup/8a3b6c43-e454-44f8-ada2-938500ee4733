...
export const metadata: Metadata = {
  title: "Bean & Brew - Premium Coffee Shop Experience",
  description: "Discover artisan roasted coffee beans and expertly crafted beverages at Bean & Brew. Premium coffee experience with exceptional quality and service.",
  keywords: "coffee shop, premium coffee, artisan roasted, espresso, latte, cappuccino, cold brew, coffee beans",
  metadataBase: new URL("https://beanandbrewcoffee.com"),
  alternates: {
    canonical: "https://beanandbrewcoffee.com"
  },
  openGraph: {
    title: "Bean & Brew - Premium Coffee Shop Experience",
    description: "Discover artisan roasted coffee beans and expertly crafted beverages at Bean & Brew. Premium coffee experience with exceptional quality and service.",
    url: "https://beanandbrewcoffee.com",
    siteName: "Bean & Brew Coffee",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Bean & Brew - Premium Coffee Shop Experience",
    description: "Discover artisan roasted coffee beans and expertly crafted beverages at Bean & Brew.",
